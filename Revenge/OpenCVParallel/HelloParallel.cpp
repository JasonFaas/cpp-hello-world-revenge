...
int main()
{
	...
	Mat mandelbrotImg(rows, columns, CV_8U);
	...
	Mat mandelbrotImgSequential(rows, columns, CV_8U);
	...
	imshow("parallel", mandelbrotImg);
	imshow("sequentials", mandelbrotImgSequential);
	waitKey(0);
